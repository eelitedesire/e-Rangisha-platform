...
<title><?php echo $site_title; ?> - Apply to get your Document</title>
...
<h2 class="product-title">Apply to Get your document soon</h2>
<ol class="breadcrumb">
<li><a href="./">Document seeker /</a></li>
<li style="color:white;" class="current">Get it now</li>
</ol>
</div>
</div>
</div>
...
<h3>
Apply now to get your document soon
</h3>
...
<i class="lni-user"></i>
<input type="text" name="fullname1" class="form-control"  required placeholder="Enter Full Name" >
...
<input type="email" name="UserEmail" class="form-control" required placeholder="Email Address" >
...
<div class="input-icon">
<i class="lni-phone"></i>
<input type="tel" name="phone" class="form-control" name="phone" required placeholder="Phone Number" >

</div>

</div>
<p>Your document type:</p>
<input type="text" name="categories" id="" class="form-control" placeholder="Enter your document type" >
<p>Put here document number</p>
<div class="form-group">
<div class="input-icon">
<i class="lni-lock"></i>
<input type="text" name="doc_number" required class="form-control" placeholder="Enter number of document" title="⚠️Pay Attention Here because this information we will use to search your document please fill clear⚠️" >
</div>
<!-- All countries -->
...
<input  type="submit" id="register" name="register" onclick="return val_a();" value="Apply now" class="btn btn-common log-btn">
</div>
</form>
<?php include 'registerdoc.php'?>
</div>
</div>
</div>
</div>
