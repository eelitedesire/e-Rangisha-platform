...
<head>
    ...
    <title><?php echo $site_title; ?> - Upload Post</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
            <h4 class="page-header">Upload Post</h4>
        </div>
            </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="alert alert-info">
                                This feature is not available in admin mode, create a standard user to start share your Post.
                            </div>
