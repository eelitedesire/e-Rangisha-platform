...
<head>
    ...
    <title><?php echo $site_title; ?> - Active Post</title>
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                  ...
                                  $stmt = $conn->prepare("SELECT * FROM tbl_ads LEFT JOIN tbl_users ON tbl_users.user_id = tbl_ads.author WHERE tbl_ads.status = 'active'");
                                  $stmt->execute();
