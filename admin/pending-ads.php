...
<head>
    ...
    <title><?php echo $site_title; ?> - Pending Post</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
            <h4 class="page-header">Pending Post</h4>
        </div>
            </div>
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                  ...
                                  $stmt = $conn->prepare("SELECT * FROM tbl_ads LEFT JOIN tbl_users ON tbl_users.user_id = tbl_ads.author WHERE tbl_ads.status = 'inactive'");
                                  $stmt->execute();
