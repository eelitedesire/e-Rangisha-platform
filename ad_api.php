...
<span><a> Founded : <strong> <?php echo $fixed; ?></strong></a></span>
</div>
...
<div class="widget">
<h4 class="widget-title">Document Posted: <?php echo $post_date; ?></h4>
...
<input type="text" name="email" required class="form-control" placeholder="Document number" title=" be care full to fill here">
<input type="text" name="phone" required class="form-control" placeholder="Your Phone">
<textarea  class="form-control" name="message" required > This losted Document Called [<?php echo $title; ?>] you found it in [<?php echo $city; "on" ?>] is mine  and I'd like to know how can i get it Thank you 😊😊😊😊 .</textarea>
...
<div class="widget">
<h4 class="widget-title">More Document From you</h4>
<ul class="posts-list">
...
<i class="lni-pointer"></i>
	     ...
	     <div class="alert alert-danger closeable">
          <h3>This document is not available for now</h3>
