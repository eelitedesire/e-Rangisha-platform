...
<div class="contentbox">
<h2><a>Active Post</a></h2>
<h3><?php echo number_format($active_ads); ?> Active Post</h3>
</div>
</div>
</div>
<div class="col-xs-6 col-sm-6 col-md-6 col-lg-4">
...
<div class="contentbox">
<h2><a>Pending Post</a></h2>
<h3><?php echo number_format($pending_ads); ?> Pending Post</h3>
</div>
</div>
</div>
</div>
...
<input id="UserName"  class="form-control input-md" name="user_name" value="<?php echo $myusername; ?>"  placeholder="Enter your username" readonly="readonly" required type="text">
...
<h6>if you want to change your email contact an admin</h6>
<input type="email" id="UserEmail" class="form-control input-md" name="user_email" value="<?php echo $myemail; ?>" placeholder="Enter your email" readonly="readonly" required type="email">
<div class="tg-checkbox mt-3">
</div>
</div>
...
<div class="dashboard-box">
<h2 class="dashbord-title">Image Update</h2>
</div>
