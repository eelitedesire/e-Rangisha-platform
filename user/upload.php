...
<title><?php echo $site_title; ?> - Upload Documents </title>
...
<label class="control-label"> Enter Number of Document losted:</label>
<input class="form-control input-md" name="brand" placeholder="Enter number of document" type="text" id="search" required>
</div>
<div >
...
<h2 class="dashbord-title">Post Detail</h2>
</div>
<div class="dashboard-wrapper">
  <form action="app/new-ad.php" method="POST" autocomplete="off" onsubmit="var text = document.getElementById('minle').value; if(text.length >= 15) { alert('Short description should be not less than 15 Characters'); return false; } return true;">
<div class="form-group mb-3">
<label class="control-label">Names are in document</label>
<input class="form-control input-md" name="title" placeholder="Enter the name of people who losting" required type="text">
</div>
...
<option value="Used">Bad Condition</option>
</select>
</div>
</div>
...
<div class="form-group mb-3">
<label class="control-label">Phone number: (start  with your country code eg: +250 *********)</label>
<input class="form-control input-md" name="price" required placeholder="Enter number with country code" type="number" >
...
<textarea maxlength="10" id="minle" class="form-control input-md" name="shortdesc" required></textarea>
</div>
