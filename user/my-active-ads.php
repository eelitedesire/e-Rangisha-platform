...
<title><?php echo $site_title; ?> - My Active Post</title>
...
<h2 class="product-title">My Active Post</h2>
<ol class="breadcrumb">
<li><a href="../">Home /</a></li>
<li class="current" style="color:white">My Active Post</li>
</ol>
</div>
</div>
</div>
...
<h2 class="dashbord-title">My Active Post</h2>
</div>
