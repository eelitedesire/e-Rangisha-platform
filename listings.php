...
<p class="dsc limit-text-desc"><?php echo substr($row['short_desc'],0,50)."..."; ?></p>
<div class="listing-bottom">
<a href="#"  class="btn btn float-left" onclick="window.open('https://wa.me/<?php echo ($row['price']); ?> ')" ><img src="icon/whatsms.png" alt="" srcset="" > &nbsp Chat Now</a>
